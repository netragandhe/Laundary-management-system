      ...
      <div className="login-card-container">
        <div className="login-split-card">
          ...
          <div className="card-image-side">
            ...
            <div className="side-hero-content" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', height: '100%' }}>
              {/* Card Footer */}
              <div className="side-hero-footer" style={{ textAlign: 'center' }}>
                <p>&copy; {new Date().getFullYear()} Kiaan Technology Inc.</p>
              </div>
            </div>
          </div>
          ...
          <div className="card-form-side">
            <div className="card-form-content">
              ...
              <div className="mobile-card-brand">
                <div className="logo-wrapper" style={{ width: '80px', height: '80px', padding: '8px', background: '#000000', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 20px -4px rgba(245, 158, 11, 0.3)', border: '1px solid rgba(245, 158, 11, 0.3)', margin: '0 auto' }}>
                  <img src="/logo.png" alt="KT Logo" className="w-full h-full object-contain rounded-xl" />
                </div>
                <h2 className="brand-title" style={{ fontSize: '1.5rem', fontWeight: '800', color: '#fff', margin: '0.75rem 0 0 0', textAlign: 'center' }}>Kiaan Technology</h2>
              </div>
